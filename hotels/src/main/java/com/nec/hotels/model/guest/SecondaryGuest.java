...
public class SecondaryGuest extends GuestDTO {
    public SecondaryGuest() {
    }

    public SecondaryGuest(UUID id, String firstName, String lastName, Title title, String nationality, boolean isVIP, GuestDocuments guestDocuments, long dateOfBirth, Integer documentNameValidation, Integer documentImageValidation, String pmsGuestId, boolean isFrro, GuestType type) {
