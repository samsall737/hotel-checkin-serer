...
public class KidsGuest extends SecondaryGuest {
	
	public KidsGuest() {
		setType(GuestType.KIDS);
		
	}

	public KidsGuest(UUID id, String firstName, String lastName, Title title, String nationality, boolean isVIP, GuestDocuments guestDocuments, long dateOfBirth, Integer documentNameValidation, Integer documentImageValidation, String pmsGuestId, boolean isFrro, GuestType type) {
