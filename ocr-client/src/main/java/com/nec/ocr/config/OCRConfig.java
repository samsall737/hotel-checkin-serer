...
public class OCRConfig {
	...
	@Bean
	public OCRClient ocrClient(@Value("${connection.read.timeout.second:60}") final Long timeoutSeconds,
							   @Value("${ocr.base.url}") final String baseUrl) {
		return new Retrofit.Builder()
				...
				.addCallAdapterFactory(RxJava2CallAdapterFactory.create()).build().create(OCRClient.class);
	}
